--Made by Quantum Roblox: Quantum Discord:why_you_need_this?.
-- V4.4 Blur
-- pls don't steal ma script!
...
local Themes = {
	...
	Dark = {
		primary     = Color3.fromRGB(8,  0,  0 ),
		sidebar     = Color3.fromRGB(8,  0,  0 ),
		secondary   = Color3.fromRGB(8,  0,  0 ),
		tertiary    = Color3.fromRGB(22, 10, 10),
		accent      = Color3.fromRGB(180, 20, 20),
		text        = Color3.fromRGB(255, 255, 255),
		textDim     = Color3.fromRGB(140, 140, 140),
		stroke      = Color3.fromRGB(50, 15, 15),
		strokeHover = Color3.fromRGB(80, 25, 25),
...
if rememberLang then
	...
	-- Update Friends menu text after language change
local function UpdateFriendsMenuText()
	local friendTextMap = {
		TR = "Arkadaşlar",
		EN = "Friends",
		ES = "Amigos",
	...
	-- Find and update the Friends tab text
	pcall(function()
		local friendsTab = gui:FindFirstChild("FriendsTab") or gui:FindFirstChild("friendTab")
		if friendsTab then
			friendsTab.Text = friendTextMap[selectedLang] or "Friends"
		end
	end)
end

UpdateFriendsMenuText()
	SaveData()
end
...
local L = {
	...
	madeBy = isTR and "Quantum tarafından yapıldı" or (isES and "Hecho por Quantum" or (isAR and "صنع بواسطة Quantum" or (isFR and "Fait par Quantum" or (isHI and "Quantum द्वारा निर्मित" or (isPT and "Feito por Quantum" or (isRU and "Сделано Quantum" or "Made by Quantum")))))),
...
local Icons = {
	Emote = "rbxassetid://11713358162",
	Sort = "rbxassetid://113816420281431", 
	Refresh = "rbxassetid://118022067240046",
...
avatar.Image = "https://www.roblox.com/headshot-thumbnail/image?userId=5232148871&width=150&height=150&format=png"
avatar.ZIndex = 10003
avatar.Parent = avatarHolder
Instance.new("UICorner", avatar).CornerRadius = UDim.new(1, 0)

local avatarGlow = Instance.new("UIStroke")
avatarGlow.Color = Color3.fromRGB(180, 20, 20)
...
task.spawn(function()
	...
	while loadingLbl.Parent do
		loadingLbl.Text = "Lagrande Emotes " .. L.loading .. dots[i]
		i = i % 4 + 1
		task.wait(0.4)
	end
end)
...
discordBtn.Text = "Join our melatonya Discord server!"
...
discordBtn.MouseButton1Click:Connect(function()
	pcall(function() if setclipboard then setclipboard("https://discord.gg/A7yYu4vGFg") end end)
...
local ThemeGradients = {
	Dark        = {Color3.fromRGB(40, 10, 10),  Color3.fromRGB(8, 0, 0),   135},
...
ApplyTheme = function(name)
	...
	if not gradFrame then
		...
		gradFrame.BackgroundTransparency = 0.1
...
_tabIndicator.BackgroundTransparency = 0.1
...
ShowFriendRequestPanel = function(senderUserId, senderName)
	...
	brand.BackgroundTransparency = 1; brand.Text = "Lagrande Emote Player"
...
miniIcon.Image = "rbxassetid://57248129"
...
hudCreator.Text                   = "Lagrande Emotes"
...
local function _applyMetaToInfoPanel(meta)
	...
	hudCreator.Text = (meta.creatorName and meta.creatorName ~= "") and meta.creatorName or "Lagrande Emotes"
end
